...
package in.reweyou.reweyou.customView.swipeRefresh;
...
//    }
    ...
    private class OvalShadow extends OvalShape {
        ...
        public void draw(Canvas canvas, Paint paint) {
            final int x = in.reweyou.reweyou.customView.swipeRefresh.MaterialDrawable.this.getBounds().centerX();
            final int y = in.reweyou.reweyou.customView.swipeRefresh.MaterialDrawable.this.getBounds().centerY();
