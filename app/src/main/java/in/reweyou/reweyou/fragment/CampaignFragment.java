...
public class CampaignFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener {
...
//}
    ...
    public class JSONTask extends AsyncTask<String, String, List<MpModel>> {
        ...
        protected List<MpModel> doInBackground(String... params) {
            ...
            //  tag="All";
            try {
                URL url = new URL("https://www.reweyou.in/reweyou/campaign.php");
                ...
                Log.d("array", String.valueOf(parentArray));
