...
import in.reweyou.reweyou.adapter.ReactionsAdapter;
import in.reweyou.reweyou.classes.UserSessionManager;
import in.reweyou.reweyou.model.CommentsModel;


public class ReactionsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState)
    {
        ...
        Messages();
        adapter=new ReactionsAdapter(getActivity(),CommentsModelList);
    ...
    public class JSONTask extends AsyncTask<String, String, List<CommentsModel>> {
        ...
        protected List<CommentsModel> doInBackground(String... params) {
            ...
            //  tag="All";
            try {
                URL url = new URL("https://www.reweyou.in/reweyou/likes_notification.php");
        ...
        protected void onPostExecute(List<CommentsModel> result) {
            ...
            ReactionsAdapter adapter = new ReactionsAdapter(getActivity(),result);
            recyclerView.setAdapter(adapter);
