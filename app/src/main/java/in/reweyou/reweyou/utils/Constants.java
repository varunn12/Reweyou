...
public class Constants {
    ...
    public static final String MY_CITY_URL = "https://www.reweyou.in/reweyou/cityfeed.php";
    ...
    public static final String POST_REPORT_KEY_HEADLINE = "headline";
    public static final String POST_REPORT_KEY_NAME = "name";
    public static final String POST_REPORT_KEY_NUMBER = "number";
    public static final String POST_REPORT_KEY_DESCRIPTION = "description";
