...
public class SmoothStreamRenderBuilder extends RenderBuilder {
    ...
    // Context kept for consistency with the HLS and Dash builders
    ...
    protected class AsyncSmoothStreamBuilder extends AsyncBuilder implements ManifestFetcher.ManifestCallback<SmoothStreamingManifest> {
        ...
        protected void buildRenderers(SmoothStreamingManifest manifest) {
            ...
            if (manifest.protectionElement != null) {
                ...
                try {
                    drmSessionManager = StreamingDrmSessionManager.newFrameworkInstance(manifest.protectionElement.uuid, player.getPlaybackLooper(), drmCallback, null, player.getMainHandler(), player);
